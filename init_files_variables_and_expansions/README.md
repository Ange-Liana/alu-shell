...
script 2 adds /action to the PATH. /action should be the last directory the shell looks into when looking for a program.
...
scriptt 11 converts a number from base 2 to base 10.
